...
# def My_DiT_test(**kwargs):
#     return DiT(depth=10, hidden_size=768, patch_size=16, num_heads=6, **kwargs)
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        x = torch.ones(bs * 12 * resolution * resolution).reshape(bs, 12, resolution, resolution)
        t = torch.ones(bs)
